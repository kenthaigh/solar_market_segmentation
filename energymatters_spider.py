...
class EnergySpider(scrapy.Spider):
    ...
    start_urls = ['https://www.energymatters.com.au/solar-location/abbotsford-2046/',     # First page
                  ...
                  'https://www.energymatters.com.au/solar-location/oak-flats-2529/',      # Restart after broken link
                  'https://www.energymatters.com.au/solar-location/kangaroo-creek-2460/', # Restart after broken link
                  'https://www.energymatters.com.au/solar-location/homebush-west-2140/',  # Restart after broken link
                  'https://www.energymatters.com.au/solar-location/gordon-park-4031/',    # Restart after broken link
                  'https://www.energymatters.com.au/solar-location/daintree-4873/',       # Restart after broken link
                  'https://www.energymatters.com.au/solar-location/beaumont-2577/']       # Restart after broken link
